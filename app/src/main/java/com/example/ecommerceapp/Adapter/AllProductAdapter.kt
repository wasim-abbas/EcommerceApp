...
class AllProductAdapter(mainActivity: MainActivity) : RecyclerView.Adapter<AllProductAdapter.AllProductViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AllProductViewHolder {
        val v =
            LayoutInflater.from(parent.context).inflate(R.layout.vertical_item_view, parent, false)
        return AllProductViewHolder(v)
    }
